...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modal_repuestos__ = __webpack_require__(508);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_models__ = __webpack_require__(42);
...
var ModalRepuestosPage = (function () {
    ...
    ModalRepuestosPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.showLoader();
        this.productoRepuestoReporteProvider.getDetalleCatalogoReporteByCabeceraCodigo(18, 1347).subscribe(function (data) {
            //  this.productoRepuestoReporteProvider.getDetalleCatalogoReporteByCabeceraCodigo(this.detalleCatalogoReporte.id,this.producto.idModelo.id).subscribe(data => {
